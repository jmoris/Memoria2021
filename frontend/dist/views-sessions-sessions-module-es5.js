...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-sessions-sessions-module"], {
  ...
  /***/
  function srcAppViewsSessionsOauthOauthComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OauthComponent", function () {
    ...
    var src_app_services_institucion_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function OauthComponent(fb, auth, router, route, instService) {
        _classCallCheck(this, OauthComponent);
      ...
      _createClass(OauthComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (params) {
            ...
            _this3.auth.loginOauth2(response);

            if (!response.success) {
              _this3.msgError = response.message;
              _this3.check = false;
              _this3.loading = false;
            } else {
              if (response.role == 'Administrador') {
                _this3.router.navigate(['/dashboard/v1']).then(function () {
                  window.location.reload();
                });
              } else if (response.role == 'Alumno') {
                _this3.router.navigate(['/dashboard/v2']).then(function () {
                  window.location.reload();
                });
              } else if (response.role == 'Profesor') {
                _this3.router.navigate(['/dashboard/v4']).then(function () {
                  window.location.reload();
                });
              } else if (response.role == 'Superadministrador') {
                _this3.router.navigate(['/dashboard/admin']).then(function () {
                  window.location.reload();
                });
              }
            }
            ...
            if (error === 'Unknown Error') {
              _this3.msgError = 'No se puede conectar al servidor.';
              _this3.check = false;
              _this3.loading = false;
            }

            _this3.msgError = error.message;
            _this3.check = false;
            _this3.loading = false;
          });
        }
    ...
    OauthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZpZXdzL3Nlc3Npb25zL29hdXRoL29hdXRoLmNvbXBvbmVudC5zY3NzIn0= */"],
      data: {
        animation: [src_app_shared_animations_shared_animations__WEBPACK_IMPORTED_MODULE_1__["SharedAnimations"]]
      }
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OauthComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
          selector: 'app-oauth',
        ...
        return [{
          ...
          type: src_app_services_institucion_service__WEBPACK_IMPORTED_MODULE_5__["InstitucionService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppViewsSessionsSessionsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _oauth_oauth_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var SessionsRoutingModule =
    /*#__PURE__*/
    _createClass(function SessionsRoutingModule() {
  ...
  function srcAppViewsSessionsSessionsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SessionsModule =
    /*#__PURE__*/
    _createClass(function SessionsModule() {
  ...
  function srcAppViewsSessionsSigninSigninComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(SigninComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteConfigLoadStart"] || event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["ResolveStart"]) {
              _this4.loadingText = 'Cargando modulos...';
              _this4.loading = true;
            }
        ...
        value: function signin() {
          ...
          this.auth.login(f.institucion, f.email, f.password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
            console.log(_this5.auth.currentUserValue);
            console.log("afsadf");

            if (!data.success) {
              _this5.msgError = data.message;
              _this5.check = false;
              _this5.loading = false;
            } else {
              var currentUser = _this5.auth.currentUserValue;

              if (currentUser.rut == '1-9') {
                _this5.router.navigate(['/session/fill/' + currentUser.id]);
              }

              if (currentUser.role == 'Administrador') {
                _this5.router.navigate(['/dashboard/v1']).then(function () {
                  window.location.reload();
                });
              } else if (currentUser.role == 'Alumno') {
                _this5.router.navigate(['/dashboard/v2']).then(function () {
                  window.location.reload();
                });
              } else if (currentUser.role == 'Profesor') {
                _this5.router.navigate(['/dashboard/v4']).then(function () {
                  window.location.reload();
                });
              } else if (currentUser.role == 'Superadministrador') {
                _this5.router.navigate(['/dashboard/admin']).then(function () {
                  window.location.reload();
                });
              }
            }
            ...
            //this.error = error;
            if (error === 'Unknown Error') {
              _this5.msgError = 'No se puede conectar al servidor.';
              _this5.check = false;
              _this5.loading = false;
            }

            _this5.msgError = error.message;
            _this5.check = false;
            _this5.loading = false;
          });
        }
    ...
    SigninComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[2, "text-align", "center"], [2, "width", "40vw", "background-color", "white", "border", "1px solid gainnsboro"], [1, "spinner", "spinner-bubble", "spinner-bubble-primary", "mr-3"]],
    ...
    function () {
      ...
      _createClass(SignupComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteConfigLoadStart"] || event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["ResolveStart"]) {
              _this6.loadingText = 'Cargando modulos...';
              _this6.loading = true;
            }
        ...
        value: function updateInfo() {
          ...
          this.auth.updateInfo(f.rut, f.enrollment, f.password).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
            if (!data.success) {
              _this7.msgError = data.message;
              _this7.check = false;
              _this7.loading = false;
            } else {
              _this7.auth.logout();

              _this7.router.navigateByUrl('/dashboard/v1');
            }
          }, function (error) {
            //this.error = error;
            if (error === 'Unknown Error') {
              _this7.msgError = 'No se puede conectar al servidor.';
              _this7.check = false;
              _this7.loading = false;
            }

            _this7.msgError = error.message;
            _this7.check = false;
            _this7.loading = false;
          });
        }
