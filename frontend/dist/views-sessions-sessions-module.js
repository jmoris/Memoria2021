...
var ForgotComponent = /** @class */ (function () {
    ...
    ForgotComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ForgotComponent, selectors: [["app-forgot"]], decls: 33, vars: 4, consts: [[1, "card", "o-hidden"], [1, "row"], [1, "col-md-6"], [1, "p-4"], [1, "auth-logo", "text-center", "mb-4"], ["src", "assets/images/logoghtracker.png", "alt", ""], [1, "mb-3", "text-18"], ["action", ""], [1, "form-group"], ["for", "email"], ["id", "email", "type", "email", 1, "form-control", "form-control-rounded"], [1, "btn", "btn-primary", "btn-block", "btn-rounded", "mt-3"], [1, "mt-3", "text-center"], ["href", "", "routerLink", "/sessions/signin", 1, "text-muted"], [1, "col-md-6", "text-center", 2, "background-size", "cover", "background-image", "url(./assets/images/pass_olvidada.png)"], [1, "pr-3", "auth-right"], ["href", "mailto:aprodes_password@info.universidad.cl"]], template: function ForgotComponent_Template(rf, ctx) { if (rf & 1) {
...
function SigninComponent_div_17_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx_r602.msgError, " ");
} }
var _c0 = function () { return { y: "120px", opacity: "0", delay: "100ms", duration: "400ms" }; };
var _c1 = function (a1) { return { value: "*", params: a1 }; };
    ...
    SigninComponent.prototype.signin = function () {
        ...
        this.auth.login(f.email, f.password)
            ...
            if (!data.success) {
                ...
                var currentUser = _this.auth.currentUserValue;
                ...
                if (user.profile == 'admin') {
                    ...
                    _this.router.navigate(['/dashboard/v4'])
                        .then(function () {
                        window.location.reload();
                    });
                }
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.checkVerificatorDigit = function (control) {
        var run = control;
        if (run.value == "")
            return null;
    ...
    SignupComponent.prototype.checkRun = function () {
    ...
    SignupComponent.prototype.updateInfo = function () {
        var _this = this;
        this.loading = true;
        this.loadingText = 'Conectando...';
        var f = this.signinForm.value;
    ...
    SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SignupComponent, selectors: [["app-signup"]], decls: 33, vars: 5, consts: [[1, "card", "o-hidden"], [1, "row"], [1, "col-md-6", "text-center", 2, "background-size", "cover", "background-image", "url(./assets/images/photo-long-3.jpg)"], [1, "pl-3", "auth-right"], [1, "auth-logo", "text-center", "mt-4"], ["src", "assets/images/logoghtracker.png", "alt", ""], [1, "flex-grow-2"], [1, "w-100", "mb-4", 2, "text-align", "center", "width", "100%"], [1, "flex-grow-1"], [1, "col-md-6"], [1, "p-4"], [1, "mb-3", "text-18"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "rut"], ["id", "rut", "formControlName", "rut", "placeholder", "11111111-1", "type", "text", 1, "form-control", "form-control-rounded", 3, "input"], ["for", "matricula"], ["id", "matricula", "formControlName", "enrollment", "type", "text", 1, "form-control", "form-control-rounded"], ["for", "password"], ["id", "password", "formControlName", "password", "type", "password", 1, "form-control", "form-control-rounded"], [1, "btn", "btn-primary", "btn-block", "btn-rounded", "mt-3"]], template: function SignupComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Gracias por utilizar Aprodes");
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
